...
/// <summary>
/// Markdig 기반 Markdown 리더. CommonMark 풀 파싱 후 PolyDonky 모델로 매핑한다.
///
/// Phase A 의 PolyDonky 모델 범위에 맞춰 다음을 처리한다:
...
/// 표·이미지·링크는 PolyDonky.Core 가 표/이미지/하이퍼링크 노드를 도입한 뒤 매핑한다.
/// </summary>
