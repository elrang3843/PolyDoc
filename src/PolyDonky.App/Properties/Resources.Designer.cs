...
namespace PolyDonky.App.Properties
{
    internal static class Resources
    {
        ...
        internal static string DlgLibreOfficeNotFoundTitle  => Get(nameof(DlgLibreOfficeNotFoundTitle));
        internal static string DlgLibreOfficeNotFoundPrompt => Get(nameof(DlgLibreOfficeNotFoundPrompt));
